...
(function(){
  ...
  const qv=new URLSearchParams(location.search).get('view');const h=location.hash.replace('#','');go(views.includes(h)?h:(views.includes(qv)?qv:'feed'));setTimeout(()=>window.scrollTo({top:0}),50);
