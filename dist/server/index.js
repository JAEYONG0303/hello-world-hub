...
.hm-hero:before {
  ...
  width: 56%;
  height: 130%;
  background: radial-gradient(closest-side, rgba(196,241,53,.20), transparent 72%);
  pointer-events: none;
...
.hm-hero:after {
  ...
  inset: 0;
  background-image:
    linear-gradient(rgba(196,241,53,.12) 1px, transparent 1px),
    linear-gradient(90deg, rgba(196,241,53,.12) 1px, transparent 1px);
