...
<meta name="description" content="행정을 이해하고 데이터로 개선하는 사람 — 재용의 홈페이지: 프로젝트, 경력, 방향, 운영판">
...
<header class="site">
  <div class="wrap bar">
    <a class="logo" href="#top">재용<span>.</span></a>
    <nav class="menu" aria-label="주요 메뉴">
      <a href="#about">소개</a><a href="#work">프로젝트</a><a href="#path">경력·역량</a><a href="#direction">방향</a><a href="#now">지금</a><a href="#watch">의료 변화</a><a href="#outlook">AI 전망</a><a href="#ops">운영판</a>
    </nav>
    <a class="gh" href="https://github.com/JAEYONG0303/project" target="_blank" rel="noopener noreferrer">GitHub ↗</a>
  </div>
</header>
...
<!-- 보건·의료 변화 감시 (원본: content/watch.json ← my agent scripts/watch_sites.py) -->
<section class="sec" id="watch">
  <div class="wrap">
    <div class="sechead">
      <div><p class="eyebrow">Watch</p><h2>보건·의료에서 지금 바뀌는 것</h2></div>
      <p class="desc" id="watch-sub">복지부·심평원·건보공단·병원협회 등 공식 출처를 매일 한 번 확인해 새 항목만 검토합니다. 수집 실패는 "변화 없음"이 아닙니다.</p>
    </div>
    <div class="watchbar" id="watch-filter" role="group" aria-label="분류 필터"></div>
    <div class="watchlist" id="watch-list"><p class="empty">아직 반영된 항목이 없습니다.</p></div>
    <details class="wsources"><summary>감시 출처와 최근 수집 상태</summary><div class="tblwrap"><table class="wsrc" id="watch-sources"></table></div></details>
  </div>
</section>
